...
(defun dotspacemacs/config ()
  ...
  (setq auto-mode-alist
        (append '(("\\.f$" . fortran-mode)
                  ("\\.F$" . fortran-mode))
                auto-mode-alist))
  (add-hook 'fortran-mode-hook (lambda () (setq fortran-comment "!")))
  (add-hook 'f90-mode-hook (lambda () (setq f90-comment-region "!")))
  (setq org-latex-create-formula-image-program 'dvipng)
  (setq ad-redefinition-action 'accept)
  (setq org-directory "~/bin/orgs")
  (setq org-mobile-inbox-for-pull "~/bin/orgs/flagged.org")
...
(custom-set-variables
 ...
 '(custom-safe-themes
   (quote
    ("fa2b58bb98b62c3b8cf3b6f02f058ef7827a8e497125de0254f56e373abee088" "d677ef584c6dfc0697901a44b885cc18e206f05114c8a3b7fde674fce6180879" "eafda598b275a9d68cc1fbe1689925f503cab719ee16be23b10a9f2cc5872069" "99fce0c01e01cb934f373a3e8c3224f80be568c6d9a548975a5cb0a0910f0a60" "4cf3221feff536e2b3385209e9b9dc4c2e0818a69a1cdb4b522756bcdf4e00a4" "7dd0db710296c4cec57c39068bfffa63861bf919fb6be1971012ca42346a417f" "868f73b5cf78e72ca2402e1d48675e49cc9a9619c5544af7bf216515d22b58e7" "2e5705ad7ee6cfd6ab5ce81e711c526ac22abed90b852ffaf0b316aa7864b11f" default)))
 ...
 '(org-directory "~/Dropbox/bin/orgs")
